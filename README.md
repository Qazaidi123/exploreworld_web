...
**Solution:** Update the kubeconfig file by command: aws eks --region <region name> update-kubeconfig --name <cluster name>
...
## 9. GitHub Repository:   https://github.com/Qazaidi123/ecploreworld_web
